...
public sealed class SimdException : ExternalException
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SimdException" /> class with a specified error message and a reference
    ...
    /// <summary>
    ///     Initializes a new instance of the <see langword="SimdException" /> class with a specified error message and the
